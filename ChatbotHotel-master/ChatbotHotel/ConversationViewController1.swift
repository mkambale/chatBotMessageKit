...
//
//  Created by Manjunath K on 5/22/18.
...
internal class ConversationViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        self.messageList =  SampleData.shared.getMessages(count: messagesToFetch)
        self.messagesCollectionView.reloadData()
        self.messagesCollectionView.scrollToBottom()

        //Messaging view related changes
...
//Delegates to be implemented
// MARK: - MessagesDataSource

extension ConversationViewController: MessagesDataSource {

    func numberOfMessages(in messagesCollectionView: MessagesCollectionView) -> Int {
        return 0+messageList.count
    }
    
    func currentSender() -> Sender {
        let send = Sender(id: "1", displayName: "test")
        return send
    }
...
//        else {
    ...
    func messageBottomLabelAttributedText(for message: MessageType, at indexPath: IndexPath) -> NSAttributedString? {
        ...
        let dateString = Date().description//Formatter.string(from: message.sentDate)
...
extension ConversationViewController: MessagesDisplayDelegate {
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) {
        let avatar = Avatar(image:#imageLiteral(resourceName: "ash"), initials: "SJ")
